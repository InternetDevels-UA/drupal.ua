    ...
    switch ($id) {
      ...
      case 'field_city_value':
        if ($field->content) {
          ...
          $address = '<address itemprop="location" itemscope itemtype="http://schema.org/Place"><div>' . $name . '<meta itemprop="name" content="' . $vars['fields']['field_address_value']->raw . '">' . '<span itemprop="address" itemscope itemtype="http://schema.org/PostalAddress">' . $pieces[1] . $pieces[0] . $pieces[2] . '</span>' . '</div>' . '</address>';
